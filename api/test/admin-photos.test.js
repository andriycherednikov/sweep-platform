...
async function seedPending() {
  ...
  await db.insert(photo).values({ id: 'ph1', kind: 'fan', uploaderName: 'Priya', fixtureId: f.id, filePath: 'z.jpg', thumbPath: 'z.jpg', caption: 'hi', status: 'pending' })
  return f
}
...
test('approve a fan photo → moves file, status approved, emits photo-approved', async () => {
  ...
  await db.insert(photo).values({ id: 'ph2', kind: 'fan', uploaderName: 'Priya', fixtureId: f.id, filePath: 'appr.jpg', thumbPath: 'appr.jpg', status: 'pending' })
