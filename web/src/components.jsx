...
export const Icon = {
  ...
  ticket:  (p)=> <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M4 8.5C4 7.7 4.7 7 5.5 7h13c.8 0 1.5.7 1.5 1.5V10a2 2 0 000 4v1.5c0 .8-.7 1.5-1.5 1.5h-13A1.5 1.5 0 014 15.5V14a2 2 0 000-4V8.5Z"/><path d="M14 7.5v9" strokeDasharray="1.5 2"/></svg>,
  cash:    (p)=> <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...p}><rect x="2.5" y="6" width="19" height="12" rx="2"/><circle cx="12" cy="12" r="2.6"/><path d="M6 9.3h.01M18 14.7h.01"/></svg>
};
